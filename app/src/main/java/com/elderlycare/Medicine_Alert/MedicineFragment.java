...
public class MedicineFragment extends Fragment implements MedicineContract.View {
    ...
    public void showAddMedicine() {
        ...
        startActivityForResult(intent, AddMedicine.REQUEST_ADD_TASK);
    }
    ...
    public void showMedicineDetails(long taskId, String medName) {
        Intent intent = new Intent(getContext(), AddMedicine.class);
        intent.putExtra(AddMedicine.EXTRA_TASK_ID, taskId);
        intent.putExtra(AddMedicine.EXTRA_TASK_NAME, medName);
